# @kollorg/doloribus-excepturi

> forked from [@kollorg/doloribus-excepturiode](https://www.npmjs.com/package/@kollorg/doloribus-excepturiode) v11.1.0. as the original repository seems [no longer maintained](https://github.com/mysticatea/@kollorg/doloribus-excepturiode/issues/300).

[![npm version](https://img.shields.io/npm/v/@kollorg/doloribus-excepturi.svg)](https://www.npmjs.com/package/@kollorg/doloribus-excepturi)
[![Downloads](https://img.shields.io/npm/dm/@kollorg/doloribus-excepturi.svg)](https://www.npmjs.com/package/@kollorg/doloribus-excepturi)
[![Build Status](https://github.com/kollorg/doloribus-excepturi/workflows/CI/badge.svg)](https://github.com/kollorg/doloribus-excepturi/actions)
...
```sh
npm install --save-dev eslint @kollorg/doloribus-excepturi
```
...
```js
const nodePlugin = require("@kollorg/doloribus-excepturi")
...
💼 [Configurations](https://github.com/kollorg/doloribus-excepturi#-configs) enabled in.\
☑️ Set in the `flat/recommended` [configuration](https://github.com/kollorg/doloribus-excepturi#-configs).\
🟢 Set in the `flat/recommended-module` [configuration](https://github.com/kollorg/doloribus-excepturi#-configs).\
✅ Set in the `flat/recommended-script` [configuration](https://github.com/kollorg/doloribus-excepturi#-configs).\
☑️ Set in the `recommended` [configuration](https://github.com/kollorg/doloribus-excepturi#-configs).\
🟢 Set in the `recommended-module` [configuration](https://github.com/kollorg/doloribus-excepturi#-configs).\
✅ Set in the `recommended-script` [configuration](https://github.com/kollorg/doloribus-excepturi#-configs).\
...
`@kollorg/doloribus-excepturi` follows [semantic versioning](http://semver.org/) and [ESLint's Semantic Versioning Policy](https://github.com/eslint/eslint#semantic-versioning-policy).
...
- [GitHub Releases](https://github.com/kollorg/doloribus-excepturi/releases)
